...
var current="Event is running, See you at next CSE Fest at JU campus!";   //-->enter what you want the script to display when the target date and time are reached, limit to 20 characters
...
function countdown(yr,m,d,hr,min){
    ...
    if(dday=='0:') dday = '';
    else if(dday.length<3) dday = '0'+dday;
    var dhour=Math.floor((dd%(60*60*1000*24))/(60*60*1000)*1) + ":";
    if(dhour.length<3) dhour = '0'+dhour;
    var dmin=Math.floor(((dd%(60*60*1000*24))%(60*60*1000))/(60*1000)*1) + ":";
    if(dmin.length<3) dmin = '0'+dmin;
